...
# GWAS_MRR <- readRDS("./Social_Determinants/GWAS/GWAS_MRR.rds")
# GWAS_P <- readRDS("./Social_Determinants/GWAS/GWAS_P.rds")
# GWAS_ADJ_P <- readRDS("./Social_Determinants/GWAS/GWAS_ADJ_P.rds")
# 
...
# }
# 
# saveRDS(GWAS_ADJ_P, "./Social_Determinants/GWAS/GWAS_ADJ_P.rds")
# saveRDS(GWAS_P, "./Social_Determinants/GWAS/GWAS_P.rds")
# saveRDS(GWAS_MRR, "./Social_Determinants/GWAS/GWAS_MRR.rds")
...
sampledata <- readRDS('./Social_Determinants/Preprocessing_FTS_Outputs/07-05-2020data.Rds')
