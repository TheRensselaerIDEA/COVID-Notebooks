...
# Final Project Guidance for Students
...
# Final Project: External Links

* github repository: https://github.com/TheRensselaerIDEA/COVID-Notebooks (for reference)
* My github ID: *olyerickson* (example; substitute with yours!)
* Github branch name of my submitted notebook: *erickson_final* (example; substitute with yours!)
...
# Summary and Recommendations COVIDMINDER
...
* Provide your github ID.  Indicate the issues associated with this work on GitHub. Put the original and  html version of this notebook on GitHub and make a pull request.  You will only give the link to your Github Submission on LMS. You can put this link up anytime. The link must appear by 
We will grade the latest version available on Github starting at 3:00 on Thursday, May 7 Friday .  Note that the R server is going down for maintenance for upto a week starting weekend of May 9,  so there can be no extensions or late submissions.* 
