...
# REMOVED:
# "All.Cause.death_rate" "infant_deaths" "suicide_deaths" "reclosure" "mask" "date_since_social" "date_since_reopen" "date_since_reclosure"  "beds" 
# "Assault.death_rate" "Cancer.death_rate" "Cardiovascular.death_rate" "Despair.death_rate" "PediatricAsthma" "AdultAsthma" "COPD" "AdultChronicLungDisease"
...
"\# less than 18 years of age" "\% Not Proficient in English"  
 "date_since_mask" "date_since")

# WHOLE LIST:
#("% Fair or Poor Health" "Average Number of Physically Unhealthy Days" "% Smokers" "% With Access to Exercise Opportunities" 
#"\# Chlamydia Cases" "Chlamydia Rate" "% Uninsured" "\# Primary Care Physicians" "\# Mental Health Providers" "Mental Health Provider Rate" "Mental Health Provider Ratio"
#"Preventable Hosp. Rate (White)" "% Screened (White)" "Labor Force" "% Unemployed" "# Households" "Average Daily PM2.5" "Presence of Water Violation" 
