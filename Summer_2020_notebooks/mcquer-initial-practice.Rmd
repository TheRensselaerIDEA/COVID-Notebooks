...
We're asking those who wish to participate in this exercise to...
* clone the github repository...
* create a personal branch, and...
* make additions to the repository by creating new, customized notebooks. 
...
* ...and then go to github, select your branch from the drop-down and submit a pull request.
...
Here, <span style='color:red'><b>shades of red</b></span> indicate that a 
