...
* In the Linux shell, `git checkout -b my-new-branch` ; substitute a unique name for `my-new-branch` !!!
* In RStudio Server, navigate to `COVID-Notebooks` via the **Files** panel
* Set this to be your working directory
* Make a copy of the notebook (ie `Rmd`) file using an *original, descriptive* filename
...
* When you're ready, inLinux `git commit -a -m "some comment"` where "some comment" is a useful comment describing your changes
* Finally, `git push origin my-new-branch` 
* And then got to github and submit a pull request. 
