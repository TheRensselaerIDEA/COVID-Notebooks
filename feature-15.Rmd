...
<i> This plot shows the disparity index of percentage people uninsured across the US. Here red indicates that there is a higher percentage than average who are uninsured. This data is from _______.</i>"
#I don't know where this data was from, uses the uninsured_by_state data


###US Medicaid DI
US_medicaid_DI_text = "<h4><b>How does the perecentage of people insured by medicaid compare across the United States?</b></h4>
<i> This plot shows the disparity index of percentage people insured by medicaid across the US. Here red indicates that there is a higher percentage than average who are insured by medicaid. This data is from _______.</i>"
#I don't know where this data was from, uses the uninsured_by_state data


###US Medicare DI
US_medicare_DI_text = "<h4><b>How does the perecentage of people insured by medicare compare across the United States?</b></h4>
<i> This plot shows the disparity index of percentage people insured by medicare across the US. Here red indicates that there is a higher percentage than average who are insured by medicare. This data is from _______.</i>"
#I don't know where this data was from, uses the uninsured_by_state data
```
...
colors <- c("grey","#426C85","#67a9cf","#d1e5f0","#f7f7f7","#fddbc7","#ef8a62","#b2182b")
    bins <- c(-1.25, -1, -0.75, -0.5, -0.25, 0, 0.25, 0.5, 0.75)
...
colors <- c("grey","#426C85","#67a9cf","#d1e5f0","#f7f7f7","#fddbc7","#ef8a62","#b2182b")
    bins <- c(-0.75, -0.5, -0.25, 0, 0.25, 0.5)
    pal2 <- leaflet::colorBin(colors, domain = Uninsured$DI, bins = bins, reverse=FALSE)
    labels2 <- sprintf(
      "<strong>%s</strong><br/>
...
colors <- c("grey","#426C85","#67a9cf","#d1e5f0","#f7f7f7","#fddbc7","#ef8a62","#b2182b")
    bins <- c(-0.75, -0.5, -0.375, -0.25, -0.125, 0, 0.125, 0.25, 0.375)
    pal2 <- leaflet::colorBin(colors, domain = Uninsured$DI, bins = bins, reverse=FALSE)
    labels2 <- sprintf(
      "<strong>%s</strong><br/>
      Medicare DI: %.9g",
