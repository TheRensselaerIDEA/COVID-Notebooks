...
### COVID mortality rates in the northeast don't seem to have recovered quite yet after the region became an epicenter of the COVID pandemic, but now we also see the southern US having an uptick in their mortility rates as the virus takes a greater foothold there.
...
### Once again, we see a trend in the north east where, unlike most of the rest of the U.S., testing rates are better than they are in South Korea. 
...
### The availability of hospital beds across the U.S. compared to Italy is generally negative. There is a minimal amount of states that boast above equal availability, and two of those (the dakotas) do not have a significant amount of COVID presence. **NOTE** the hospital bed and cardiovascular code/text is switched in the notebook compared to how it appears in the knit. Also error occurring on cardiovascular map.
