...
**REQUIRED:** For this assignment you will be asked to confirm the following in LMS:
    ...
    * The location of the github: https://lp01.idea.rpi.edu/rstudio-ose/files/COVID-Notebooks
    * Your github ID: hanielcampos
    * The name of your new branch: hacl-campoh
    * The location where you committed your new (copied) notebook: https://lp01.idea.rpi.edu/rstudio-ose/files/COVID-Notebooks/HACL-2020
